...
<html>
    ...
    <body>
    <form method="post" action="/add-to-cart/add?id=${product.id}">
...
<%--                                        </div>--%>
                                ...
                                <div class="cart mt-4 align-items-center">
                                        <button class="btn btn-primary text-uppercase mr-2 px-4"type="submit" onclick="return onAddToCart()">Add to cart</button> <i class="fa fa-heart text-muted"></i> <i class="fa fa-share-alt text-muted"></i>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        function onAddToCart(){
            var addToCart = confirm("Ban co muon them vao gio hang khong?")
            if (addToCart == true){
